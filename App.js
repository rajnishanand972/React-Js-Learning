...
// Day - 04 creating a food ordering app
...
const Header = () => {
    return (
        <div className='header'>
            <div><img className='header-logo' alt="logo" src="https://img.freepik.com/free-vector/detailed-chef-logo-template_23-2148987940.jpg?w=740&t=st=1702145429~exp=1702146029~hmac=4e40f0217a8330ed2418695cbb8bae69cf21e6c3a27e96483cb949f1a8a74ec3"></img></div>
...
const RestaurentCard = (props) => {
    ...
    return (
        <div className='restaurent-card'>
            <img className="restaurent-card-logo" alt="Hotel Img"src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+resDeatils.data.cloudinaryImageId}></img>
...
const Body = () => {
    return (
        ...
        {
            resList.map((restaurant) => <RestaurentCard resDeatils={restaurant}/>)
        }
        </div>
        </div>
